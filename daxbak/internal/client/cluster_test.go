...
func TestCluster_parseHostPorts(t *testing.T) {
	endpoints := []string{"daxbak.us-east-1.amazonaws.com:8111"}
	...
	if hostPorts[0].host != "daxbak.us-east-1.amazonaws.com" {
		t.Errorf("expected %v, got %v", "daxbak.us-east-1.amazonaws.com", hostPorts[0].host)
	}
...
func Test_CorrectHostPortUrlFormat(t *testing.T) {
	hostPort := "daxbak://test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com:1234"
	host, port, scheme, _ := parseHostPort(hostPort)
	assertEqual(t, "test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com", host, "")
	assertEqual(t, 1234, port, "")
	assertEqual(t, "daxbak", scheme, "")
}

func Test_MissingScheme(t *testing.T) {
	hostPort := "test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com:8111"
	host, port, scheme, _ := parseHostPort(hostPort)
	assertEqual(t, "test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com", host, "")
...
func Test_MissingPortForDax(t *testing.T) {
	hostPort := "daxbak://test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com"
	host, port, scheme, _ := parseHostPort(hostPort)
	assertEqual(t, "test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com", host, "")
	assertEqual(t, 8111, port, "")
	assertEqual(t, "daxbak", scheme, "")
...
func Test_MissingPortForDaxs(t *testing.T) {
	hostPort := "daxs://test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com"
	host, port, scheme, _ := parseHostPort(hostPort)
	assertEqual(t, "test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com", host, "")
...
func Test_UnsupportedScheme(t *testing.T) {
	hostPort := "sample://test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com"
...
func Test_DaxsCorrectUrlFormat(t *testing.T) {
	hostPort := "daxs://test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com:1234"
	host, port, scheme, _ := parseHostPort(hostPort)
	assertEqual(t, "test.nds.clustercfg.daxbak.usw2integ.cache.amazonaws.com", host, "")
	assertEqual(t, 1234, port, "")
	assertEqual(t, "daxs", scheme, "")
...
var nonEncEp = "daxbak://cluster.random.alpha-daxbak-clusters.us-east-1.amazonaws.com"
var nonEncNodeEp = "cluster-a.random.nodes.alpha-daxbak-clusters.us-east-1.amazonaws.com:8111"
var encEp = "daxs://cluster2.random.alpha-daxbak-clusters.us-east-1.amazonaws.com"
var encNodeEp = "daxs://cluster2-a.random.nodes.alpha-daxbak-clusters.us-east-1.amazonaws.com:9111"
...
func Test_MultipleUnEncryptedEndpoints(t *testing.T) {
	...
	assert.Contains(t, hps, hostPort{"cluster.random.alpha-daxbak-clusters.us-east-1.amazonaws.com", 8111})
	assert.Contains(t, hps, hostPort{"cluster-a.random.nodes.alpha-daxbak-clusters.us-east-1.amazonaws.com", 8111})
}
