...
import (
	...
	"github.com/aws/aws-dax-go/daxbak/internal/client"
	"github.com/aws/aws-dax-go/daxbak/internal/proxy"
...
// 				Endpoint: aws.String("daxbak://mycluster.frfx8h.clustercfg.daxbak.usw2.amazonaws.com:8111"),
// 			}))
//
// 		// Create a DAX client from just a session.
// 		svc := daxbak.NewWithSession(mySession)
...
func newRequestForUnimplementedOperation() *request.Request {
	...
	clientInfo := metadata.ClientInfo{ServiceName: "daxbak"}
